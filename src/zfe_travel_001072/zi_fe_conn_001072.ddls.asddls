...
define view entity zi_fe_conn_001072
  as select from zfe_aconn_001072 as Connection
  association [1..1] to zi_fe_carr_001072 as _Airline on $projection.AirlineID = _Airline.AirlineID
{
