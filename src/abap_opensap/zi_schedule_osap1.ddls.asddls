...
define view entity ZI_SCHEDULE_OSAP1 as select from zschedule_osap1 as Schedule 
  association to parent ZI_COURSE_OSAP1 as _Course on $projection.CourseUuid = _Course.CourseUuid
{
